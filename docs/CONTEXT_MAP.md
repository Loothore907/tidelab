...
- [TL-001A decision](decisions/TL-001A-INITIAL-ENGINE-SELECTION.md) / [closed issue #2](https://github.com/Loothore907/tidelab/issues/2): pinned LEAN is selected for the first synthetic historical/local-paper integration. [TL-002 issue #48](https://github.com/Loothore907/tidelab/issues/48) now has a fixed synthetic [buy/sell recovery checkpoint](evidence/TL-002-LEAN-FORWARD-SELL-LEDGER.md); it still owns general strategy/risk, ledger, runtime, and packaging work. Start at the engine decision, the TL-002 evidence, and `scripts/lean_fallback/`.
- [Issue #3](https://github.com/Loothore907/tidelab/issues/3) / [TL-001B Bitstamp decision](decisions/TL-001B-INITIAL-RESEARCH-DATA.md): Public BTC/USD hourly data is selected for bounded private noncommercial research; a locally ignored 40,896-hour historical sample and 528-hour recent bridge passed interval checks. Rights for commercial use and public real-data artifacts remain separate. Kraken's reply is no longer a dependency.
