...
- [TL-001A decision](decisions/TL-001A-INITIAL-ENGINE-SELECTION.md) / [closed issue #2](https://github.com/Loothore907/tidelab/issues/2): pinned LEAN is selected for the first synthetic historical/local-paper integration. [TL-002 issue #48](https://github.com/Loothore907/tidelab/issues/48) now has a [pinned LEAN H1 report/account handoff](evidence/TL-002-H1-LEAN-REPORT-HANDOFF.md) and [costed synthetic execution/trial accounting](evidence/TL-002-H1-CONSERVATIVE-EXECUTION-TRIAL-ACCOUNTING.md). [H1 v1](experiments/H1-V1-PREREGISTRATION.md) fixes the rule and evaluation plan before any real-data result. The next gate is a rights-checked, exact-source private historical runner; external broker finality and packaging remain separate. Start at the engine decision, these TL-002 reports, and `scripts/lean_fallback/`.
