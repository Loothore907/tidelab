...
- [Issue #9](https://github.com/Loothore907/tidelab/issues/9): this context map and handoff. It does not adopt a data source, engine, strategy, or live execution mode.
