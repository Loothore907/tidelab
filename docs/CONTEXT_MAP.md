...
| How are strategy sources parsed and batch-tested? | `docs/decisions/TL-003-DETERMINISTIC-STRATEGY-PIPELINE.md` and `docs/evidence/TL-003-PINE-SUBSET-FRONTEND.md` | `src/tidelab/strategy_batch.py`, `src/tidelab/pine_subset.py`, batch CLIs, tests, and issue #95 |
