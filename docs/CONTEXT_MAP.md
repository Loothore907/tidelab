...
- [Current handoff](../HANDOFF.md) records the latest #48 synthetic hold, the public Coinbase source-capability gaps, and the separate #3 data gate. [Issue #82](https://github.com/Loothore907/tidelab/issues/82) owns the synthetic first-pass coverage gate; verify its integration and all remote state live.
