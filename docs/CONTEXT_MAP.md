...
| How are strategy sources parsed and batch-tested? | `docs/decisions/TL-003-DETERMINISTIC-STRATEGY-PIPELINE.md` | `src/tidelab/strategy_batch.py`, `scripts/strategy_batch.py`, tests, and issue #95 |
...
- `src/tidelab/strategy_batch.py`, `scripts/strategy_batch.py`, `research/examples/strategy-batch-packages/`: source-bound normalized JSON parser and synthetic batch contract check. Raw paper, repository and Pine frontends and a historical batch backend remain open under issue #95.
