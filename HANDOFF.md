...
2. In [issue #2](https://github.com/Loothore907/tidelab/issues/2) / TL-001A, test a synthetic backed forward-paper node or equivalent public extension path for durable order/account restoration and ambiguous-outcome reconciliation without blind resubmission. The in-memory backtest process-loss probe could not restore the pending order. Do not adopt, fork, or distribute NautilusTrader merely because the earlier probes pass.
