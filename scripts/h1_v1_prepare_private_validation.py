"""Prepare one ignored H1 validation bundle after reviewing official OKX terms."""
...
from tidelab.h1_private_trial import prepare_validation
...
def main() -> None:
    ...
    result = prepare_validation(ROOT, database, archives, output, revision,
                                args.terms_reviewed_utc_date)
    print("prepared private validation input " + " ".join(
