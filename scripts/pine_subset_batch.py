...
from tidelab.pine_subset import GRAMMAR_VERSION, PineFrontendError, compile_pine
from tidelab.strategy_batch import (evaluate_batch, load_json, parse_json_bytes,
...
def main() -> None:
    ...
    print(canonical_json(run(args.sources, args.record, args.fixture, args.output)))
